...
// Verified Brevo sender: hello@getoffzillow.com
...
<body style="font-family:'Helvetica Neue',Arial,sans-serif;background:
#f4f4f4;margin:0;padding:20px">
...
#127968; New Offer Received</div>
    ...
    <div style="padding:28px 32px">
      ...
      <div style="background:
#f0fff8;border:1px solid 
#00C853;border-radius:10px;padding:20px;margin-bottom:20px">
        <div style="font-size:36px;font-weight:900;color:
#00843d">${offerPrice}</div>
      ...
      <div style="background:
#f9f9f9;border-radius:10px;padding:20px;margin-bottom:20px">
        ...
        <div style="margin-bottom:4px"><a href="mailto:${offer.buyer_email}" style="color:
#006AFF;font-size:15px;font-weight:600;text-decoration:none">${offer.buyer_email}</a></div>
      ...
      <div style="text-align:center;margin-top:24px">
        <a href="https://getoffzillow.com/dashboard.html" style="display:inline-block;background:
#006AFF;color:white;padding:14px 32px;border-radius:8px;font-weight:700;font-size:15px;text-decoration:none">View in Dashboard &#8594;</a>
      </div>
      <p style="font-size:12px;color:#999;margin-top:24px;line-height:1.6">
        ...
        Questions? <a href="mailto:hello@getoffzillow.com" style="color:
#006AFF">hello@getoffzillow.com</a>
      </p>
    </div>
    <div style="background:
#f4f4f4;padding:16px 32px;font-size:11px;color:#999;font-family:monospace">
